...
class ListenerClient(Client):
    ...
    def run(self):
        ...
        try:
            with (open("results/query1.txt", mode='a') as file1,
                  open("results/query2.txt", mode='a') as file2,
                  open("results/query3.txt", mode='a') as file3,
                  open("results/query4.txt", mode='a') as file4,
                  open("results/query5.txt", mode='a') as file5):
